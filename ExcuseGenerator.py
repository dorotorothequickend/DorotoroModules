...
class ExcuseGeneratorMod(loader.Module):
    """Ваш персональный генератор отмазок."""
    strings = {
    ...
    async def excuse(self, message):
        ...
        nameo = ["Друг","Товарищ","Заказчик",
        "Приятель","Уважаемый начальник"]
        hello = ["привет","здравствуй","приветствую","добрый день","добрый вечер",
        "доброе утро","саламули гамаджоба","салам алейкум", "hello", "здарова", "алоха"]
        fail = ["Самолет, в котором я летел, приземлился на запаснике в Новгороде",
        ...
        "У меня рак печени, к сожалению, серьезно, я сейчас химиотерапию прохожу","Я потерял всё, что было в портмоне","Меня избили цыгане",
        "Я просто в глуши был","Я просто был не в городе","Меня отправили по делам","Твой банк отклонил перевод","Мой счет заблокировали",
        "Я потерял ноутбук","У меня сломался компьютер",
        ...
        action = ["Я сделаю всё","Вышлю часть","Постараюсь","Доберусь и всё сделаю","Смогу сделать всё","Я закончу","Я доделаю","Я исправлю","Согласую всё",
        ...
        date = ["сейчас","завтра","завтра вечером","завтра днем","завтра утром","как можно быстрее",
        ...
        "ближе к утру","с утра","завтра крайний срок","на неделе","через пару дней","скоро","сразу","сейчас, в течение 3-4 дней"]
        general = ["Хочу закрыть вопрос поскорее","Сам уже устал ждать","Я бы с радостью уже все сделал","Сам в шоке, что так всё получилось",

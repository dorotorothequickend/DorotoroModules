...
class InlineTTS(loader.Module):
    """Перед началом работы с модулем необходимо подписаться на канал @silero_voice_news, иначе модуль работать не будет. Английские символы не поддерживаются. Советы: Аббревиатуры необходимо писать вот так - ЭСЭСЭСЭР, а ударение нужно ставить так - удар+ение"""
